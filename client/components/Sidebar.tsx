import { MessageSquare, Lightbulb, BarChart3, Settings, Mail, LayoutGrid, FileText, User } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <div className="w-[234px] h-screen bg-neutral-50 flex flex-col flex-shrink-0">
      {/* Header */}
      <div className="h-[52px] flex items-center justify-between px-[18px]">
        ...
        <button className="w-8 h-8 flex items-center justify-center rounded hover:bg-neutral-200/50 transition-colors">
